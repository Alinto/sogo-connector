/* ack-dialog.js - This file is part of "SOGo Connector", a Thunderbird extension.
 *
 * Copyright: Inverse inc., 2006-2021
...
function onLoad() {
  ...
  window.document.title = WL.extension.localeData.localizeMessage("acl-dialog.title");
